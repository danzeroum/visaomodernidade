# visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.7.1)
...
|--------|------|-----------|
| **v0.7.1** | **2026-08-14** | **Sprint 3.1:** filtro França corrigido (separa versão francesa de rota); grafo contextual 100% derivado do JSON; coluna Alterações seleciona texto no laboratório; modal com ARIA + trap de foco; histórico Voltar/Avançar; 111 testes |
...
```bibtex
@misc{visaomodernidade_v071,
  title  = {visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.7.1)},
