# visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.6.1)
...
| **v0.6.1** | **2026-08-14** | **Hotfix CI:** corrigidos nomes de schemas em `arquivos_validados` (causa da falha do PR #5); porta dinâmica e timeouts maiores nos testes E2E |
...
@misc{visaomodernidade_v040,
  title  = {visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.6.1)},
