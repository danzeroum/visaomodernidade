# visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.7.2)
...
|--------|------|-----------|
| **v0.7.2** | **2026-08-14** | **Sprint 3.2:** rótulo França refinado ("associados a versões francesas" + separação documentada/inferida); política pushState/replaceState consistente; testes E2E do modal reforçados (foco real + retorno); 113 testes |
...
```bibtex
@misc{visaomodernidade_v072,
  title  = {visaomodernidade — Pacote de Dados Acadêmicos Versionados (v0.7.2)},
